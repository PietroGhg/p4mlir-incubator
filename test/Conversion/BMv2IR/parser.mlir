...
// CHECK:    }
// CHECK:     transitions {
// CHECK:      bmv2ir.transition type  default, @prs::@parse_headers
// CHECK:    }
// CHECK:     parser_ops {
...
// CHECK:    }
// CHECK:     transitions {
// CHECK:      bmv2ir.transition type  hexstr, #int1_b8i, @prs::@parse_one
// CHECK:      bmv2ir.transition type  hexstr, #int2_b8i, @prs::@parse_two
...
// CHECK:    }
// CHECK:     transitions {
// CHECK:      bmv2ir.transition type  default, @prs::@parse_two
// CHECK:    }
// CHECK:     parser_ops {
...
// CHECK:    }
// CHECK:     transitions {
// CHECK:      bmv2ir.transition type  default, @prs::@accept
// CHECK:    }
// CHECK:     parser_ops {
// CHECK:    }
    p4hir.state @accept {
